      ...
      <View style={styles.centerContent}>
        ...
        <Text style={[styles.ctaSub, { color: textSec }]}>
          {(freeScansLeft <= 0 && !isSubscribed)
            ? 'You\'ve used your 3 free scans this month. Upgrade to Premium for unlimited scans, PDF reports, and more.'
            : 'Take a photo of your pet\'s symptom area and answer a few quick questions for an instant health analysis.'}
        </Text>
